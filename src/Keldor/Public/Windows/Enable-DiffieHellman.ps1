...
#>
    ...
    [CmdletBinding(SupportsShouldProcess = $true, HelpUri = 'https://docs.keldor.dev/powershell/keldor/Enable-DiffieHellman')]
    Param (
    ...
    foreach ($comp in $ComputerName) {
        ...
        if ($PSCmdlet.ShouldProcess($comp, "Enable Diffie-Hellman")) {
