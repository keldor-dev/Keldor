...
#>
    ...
    [CmdletBinding(SupportsShouldProcess = $true, HelpUri = 'https://docs.keldor.dev/powershell/keldor/Disable-3DES')]
    Param (
    ...
    foreach ($comp in $ComputerName) {
        ...
        $os = $wmiq.Caption
        if ($PSCmdlet.ShouldProcess($comp, "Disable Triple DES")) {
