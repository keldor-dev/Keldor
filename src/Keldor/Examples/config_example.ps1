...
$Global:KeldorConfig = [PSCustomObject]@{
    # Keldor config v2024.12
    ...
    #Update computer. Used when you have a computer you modify the module on then push it out to the update path from that computers local repository (hardcoded to $env:ProgramFiles\WindowsPowerShell\Modules\Keldor).
    ...
    UpdatePath = "\\servername\Apps\Microsoft\PowerShell\Modules\Keldor"

    #Additional paths is used for pushing out to folders in addtion to UpdatePath.
    #AdditionalUpdatePaths = @('\\servername\apps\Microsoft\PowerShell\Modules\Keldor','D:\OneDrive\Scripts\Modules\Keldor')
    ...
    # Ex for single OU: UserOUs = 'OU=Users,DC=keldor,DC=dev'
    # Ex for multiple OUs: UserOUs = @('OU=Users,OU=TestLab,DC=keldor,DC=dev','OU=Users,DC=keldor,DC=dev')
    AdminOUs = @()
    AdminGroupOUs = @()
    ...
    #DRADomain = "keldor.dev"
    #DRAHostServer = "server.keldor.dev"
    #DRAHostPort = 11192 #if not specified 11192 is used by default
    #DRARESTServer = "server.keldor.dev"
    ...
    #Sender = "noreply@keldor.dev"
    #SMTPServer = "smtprelay.keldor.dev"
    #SMTPPort = 25
    ...
    ################################
    #Open-CMLibrary
    #CMLibrary = "https://cmlibrary.keldor.dev"

    #Open-ECP/Open-EAC #exchange control panel aka exchange admin center (eac)
    #EAC = "https://owa.keldor.dev/ecp"

    #Open-HomeAssistant
    HomeAssistant = "https://homeassistant.wanderingstag.com"

    #HP iLO management in the Keldor\WS_DomainMgmt Open-iLO function
    #iLO = "https://iloaddress.keldor.dev"

    #Open-LexmarkManagementConsole and Open-PrintRelease
    #LMC = "https://lmcserver.keldor.dev/lmc"
    #PrintRelease = "https://lmcserver.keldor.dev/PrintRelease"
    ...
    #Open-OWA
    #OWA = "https://owa.keldor.dev"

    #Open-Remedy. Because of the aliases (Open-EITSM, EITSM) this can be used for any ticketing system
    #Remedy = "https://remedy.keldor.dev"

    #Open-SharePoint
    #SharePoint = "https://sharepoint.keldor.dev"

    #Open-SDNManagement aka Open-Unifi
    SDNMgmt = "https://unifi.keldor.dev"

    #Open-SEIM
    #SEIM = "https://seim.keldor.dev"

    #Open-vCenter
    #vCenter = "https://vcenter.keldor.dev/"
