...
$Global:KeldorConfig = [PSCustomObject]@{
    ...
    # Path to where module files are stored on a central server. Used in Install-Keldor (aka Copy-Keldor) and Update-Keldor
    # UpdatePath = ""
    ...
    OldPSModule                   = @('SHTool', 'SHTools', 'SkysTool', 'WSTools')
